...
summer_breaks = school_calendars[school_calendars.event_name.isin(['First Day Of School','Last Day Of School'])].pivot(
    columns='event_name', index='state', values='start').reset_index().rename(columns={'Last Day Of School':'start','First Day Of School':'end'})
