...
# ===== Visualization Plot Generation Helper Functions =====


def _get_locations_to_plot(calibrations: list[CalibrationOutput], single_config: bool | list[str]) -> set[str]:
    """
...
def _generate_single_quantile_plots(
    calibrations: list[CalibrationOutput],
    ...
    locations = _get_locations_to_plot(calibrations, plots_config.quantiles.single)
...
def _generate_quantile_grid_plot(
    calibrations: list[CalibrationOutput],
    plots_config: PlotsConfig,
    out_dict: dict[str, list[OutputObject]],
) -> None:
...
def _generate_single_location_posterior_plots(
    calibrations: list[CalibrationOutput],
    plots_config: PlotsConfig,
    out_dict: dict[str, list[OutputObject]],
) -> None:
    ...
    locations = _get_locations_to_plot(calibrations, plots_config.posterior.single)
...
def _generate_posterior_grid_plot(
    calibrations: list[CalibrationOutput],
    plots_config: PlotsConfig,
    out_dict: dict[str, list[OutputObject]],
) -> None:
...
def generate_calibration_outputs(
    *, calibrations: list[CalibrationOutput], output_config: OutputConfig, **_
    ...
    if output.plots:
        ...
        _generate_single_quantile_plots(calibrations, plots_config, out_dict)
        _generate_quantile_grid_plot(calibrations, plots_config, out_dict)
        _generate_single_location_posterior_plots(calibrations, plots_config, out_dict)
        _generate_posterior_grid_plot(calibrations, plots_config, out_dict)
